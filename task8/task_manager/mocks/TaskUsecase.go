...
func (_m *TaskUsecase) AddTask(task Domain.Task) (Domain.Task, error) {
	ret := _m.Called(task)
...
func (_m *TaskUsecase) DeleteTask(id string) (Domain.Task, error) {
	ret := _m.Called(id)
...
func (_m *TaskUsecase) GetTaskByID(id string, creater string, Rol_ string) (Domain.Task, error) {
...
func (_m *TaskUsecase) GetTasks(Role_ string, username string) ([]Domain.Task, error) {
...
func (_m *TaskUsecase) UpdateTask(id string, task Domain.Task) (Domain.Task, error) {
